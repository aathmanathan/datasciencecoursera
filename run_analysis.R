...
tsubID <- as_tibble(read.table("/Users/Arun/Documents/R codes/Coursera R work/Getting and Cleaning Data/Dataset/test/subject_test.txt",col.name="SubjectID",header=FALSE))
tact <- as_tibble(read.table("/Users/Arun/Documents/R codes/Coursera R work/Getting and Cleaning Data/Dataset/test/y_test.txt",header=FALSE,col.names = "ActivityID"))
tdata <- as_tibble(read.table("/Users/Arun/Documents/R codes/Coursera R work/Getting and Cleaning Data/Dataset/test/X_test.txt",header=FALSE))

#Pull data from training set files - SubjectID, Activity and Movement data
trsubID <- as_tibble(read.table("/Users/Arun/Documents/R codes/Coursera R work/Getting and Cleaning Data/Dataset/train/subject_train.txt",header=FALSE))
tract <- as_tibble(read.table("/Users/Arun/Documents/R codes/Coursera R work/Getting and Cleaning Data/Dataset/train/y_train.txt",header=FALSE))
trdata <- as_tibble(read.table("/Users/Arun/Documents/R codes/Coursera R work/Getting and Cleaning Data/Dataset/train/X_train.txt",header=FALSE))
